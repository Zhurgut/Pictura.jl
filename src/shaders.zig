...
pub const ShaderModules = struct {
    ...
    pub fn destroy(s: *ShaderModules, device: vulkan.VkDevice) void {
        ...
        vulkan.vkDestroyShaderModule.?(device, s.draw_image, null);
        vulkan.vkDestroyShaderModule.?(device, s.draw_rect, null);
        vulkan.vkDestroyShaderModule.?(device, s.mix_channels, null);
        vulkan.vkDestroyShaderModule.?(device, s.mix_channels2, null);
        vulkan.vkDestroyShaderModule.?(device, s.draw_ellipse, null);
        vulkan.vkDestroyShaderModule.?(device, s.draw_color, null);
        vulkan.vkDestroyShaderModule.?(device, s.filter, null);
        ...
        vulkan.vkDestroyShaderModule.?(device, s.quad_out, null);
    }
};
